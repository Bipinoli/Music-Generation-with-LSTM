...
source_folder = 'data/full_shifted_dataset/original' + subfolder
tempo_folder1 = 'data/full_shifted_dataset/'  + 'tempo' + subfolder
histo_folder1 = 'data/full_shifted_dataset/'  + 'histo' + subfolder


tempo_folder2 = 'data/full_shifted_dataset/' + shift_folder + 'tempo' + subfolder
shifted_folder = 'data/full_shifted_dataset/' + shift_folder + 'shifted' + subfolder
pickle_folder = 'data/full_shifted_dataset/' + shift_folder + 'pianoroll' + subfolder
roll_folder = 'data/full_shifted_dataset/' + shift_folder + 'indroll' + subfolder
histo_folder2 = 'data/full_shifted_dataset/' + shift_folder + 'histo' + subfolder
chords_folder = 'data/full_shifted_dataset/' + shift_folder + 'chords' + subfolder
chords_index_folder = 'data/full_shifted_dataset/' + shift_folder + 'chord_index' + subfolder
song_histo_folder = 'data/full_shifted_dataset/' + shift_folder + 'song_histo' + subfolder
...
dict_path = 'data/full_shifted_dataset'
...
# Chord triad tuple to chord name
chord_triad_tuple_to_chord_name = {
    tuple((0,4,7)): "C",
    tuple((0,3,7)): "Cm",
    tuple((0,5,7)): "Csus4",
    tuple((0,7,9)): "Csus6",
